<template>
  <MenuContainer ref="container" :arrowX="25 + (3 * 60)" :height="300" :title="'System'">
    <Container v-for="(v, i) in tabs" :key="i" :x="6.5 + (i * 67)" :y="6.5">
      <RoundRectangle @create="rr" :width="60" :height="24" :lineWidth="1" :strokeColor="COLORS.brown" :radius="6" :fillColor="index === i ? COLORS.brown : null" @pointerdown="index = i" />
...
export default {
  ...
  setup () {
    ...
    return {
      ...
      rr: obj => {
        console.log(obj, obj.setPipeline)
        // obj.texture.setFilter
      }
    }
  }
}
