<template>
  <Container :x="left" :y="top">
    ...
    <Image texture="menu_label" :origin="0" :x="-15" :y="20" :rotation="-0.07" />
    <Text :text="title" :x="1" :y="28" :rotation="-0.07" :size="14" :bold="true" color="soy" />
    <Container :x="padding" :y="labelSpace + padding">
      <slot />
    </Container>
  </Container>
</template>
