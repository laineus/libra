<template>
  <Container>
    <template v-if="step === 0">
      <Rectangle :fillColor="config.COLORS.black" :origin="0" :width="config.WIDTH" :height="config.HEIGHT" :alpha="0" :tweens="bgTweens" />
    ...
    <Container v-else-if="step === 1" :x="180" :y="config.HEIGHT.half - 60" :tweens="creditTweens" :alpha="0">
      <Text text="Written by" color="white" :y="-13" :size="12" />
      <Text text="Laineus" color="white" :y="13" :size="18" />
    </Container>
    <Container v-else-if="step === 2" :x="(180).byRight" :y="config.HEIGHT.half + 60" :tweens="creditTweens" :alpha="0">
