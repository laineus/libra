<template>
  <Container>
    ...
    <Text :text="`${setting.state.bgm}%`" :x="212" :y="14" :originX="1" :size="14" :bold="true" />
    ...
    <Text :text="`${setting.state.se}%`" :x="212" :y="54" :originX="1" :size="14" :bold="true" />
    ...
    <Text text="日本語" :x="26" :y="127" :originY="0.5" :size="13" :bold="true" @pointerdown="setLang('ja')" />
    ...
    <Text text="English" :x="106" :y="127" :originY="0.5" :size="13" :bold="true" @pointerdown="setLang('en')" />
  </Container>
</template>
