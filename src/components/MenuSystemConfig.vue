<template>
  <Container>
    ...
    <Slider :x="11" :y="34" :width="207" :height="9" :max="100" :bgColor="COLORS.soy" v-model="model.bgm" @commit="commit" />
    <!-- SE -->
    <Text :text="t('ui.seVolume')" :x="11" :y="54" :size="14" :bold="true" />
    <Text :text="`${setting.state.se}%`" :x="217" :y="54" :originX="1" :size="14" />
    <Slider :x="11" :y="77" :width="207" :height="9" :max="100" :bgColor="COLORS.soy" v-model="model.se" @commit="commit" />
    <!-- LANG -->
    <Text text="Lang" :x="11" :y="100" :size="14" :bold="true" /><!-- Must not be translated -->
    <Circle :x="18" :y="131" :lineWidth="1" :strokeColor="COLORS.brown" :radius="7" @pointerdown="setLang('ja')" />
    <Circle v-if="setting.state.lang === 'ja'" :x="18" :y="131" :fillColor="COLORS.brown" :radius="4" />
    <Text text="日本語" :x="31" :y="132" :originY="0.5" :size="13" :bold="true" @pointerdown="setLang('ja')" />
    <Circle :x="98" :y="131" :lineWidth="1" :strokeColor="COLORS.brown" :radius="7" @pointerdown="setLang('en')" />
    <Circle v-if="setting.state.lang === 'en'" :x="98" :y="131" :fillColor="COLORS.brown" :radius="4" />
    <Text text="English" :x="111" :y="132" :originY="0.5" :size="13" :bold="true" @pointerdown="setLang('en')" />
    <!-- Back to title -->
