...
export default [
  ...
  makeCharacter('pig', { hp: 20, atk: 5, temper: FISH, speed: 60, weight: 2 }),
  makeCharacter('ghost', { hp: 50, atk: 15, temper: CAT, speed: 60, standingAnim: true, damage: false }),
  makeCharacter('pumpkin', { hp: 20, atk: 15, temper: FISH, speed: 50, weight: 2, drop: [{ key: 'coinGold', chance: 1 }, { key: 'coinSilver', chance: 1 }, { key: 'coinSilver', chance: 0.7 }] }),
