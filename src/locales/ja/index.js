export default {
  ...
  tips: {
    ...
    charm: {
      title: '魅力',
      desc: '魅力は、恋人のアミリと散歩したり寝たりすると上昇します。魅力が上がるとこの世界のより深くへ進めます。'
    },
    weight: {
      title: 'アイテムの重さ',
    ...
    use: {
      title: 'アイテムの使用',
      desc: '使用できるアイテムをつかむと、かばんの下部にアイコンが表示されます。アイコンにドロップすることでアイテムが使用されます。'
    },
    dispose: {
      title: 'アイテムの破棄',
    ...
    people: {
      title: '住人',
      desc: 'フィールドには、会話ができる生き物がいます。彼らの頼みごとを聞いてリンゴを手に入れましょう。'
    },
    gun: {
      title: '銃',
      desc: '銃を手に入れると、フィールドで使うことができます。アイテムや生き物を破壊・殺害することができます。'
    },
    murder: {
      title: '殺害',
